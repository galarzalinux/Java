...
public class Perro extends Animal{
	...
	public void comer(){
		System.out.println("El perro come "+nombre);
	}
	
	public void comer(String ... s){
		System.out.println("El perro come Chicloforito!!!!!!!!!!!!!!!!!!!!!!!");
		for (String cadena : s) {
	...
	public void comer(String croquetascachorro,int leche){
		System.out.println("El perro come croquetas marca "+croquetascachorro+
				" y "+leche+" tazas de leche");
	}
	 
	public void comer(String croquetasadulto){
		System.out.println("El perro come croquetas marca "+croquetasadulto);
	}
